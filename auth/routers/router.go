...
func CreateRouter(authV1 *handlers.Auth, authCli pb.AuthClient) chi.Router {
	r := chi.NewMux()
	...
	r.Route("/v1", func(r chi.Router) {
		...
		r.
			With(httputil.AuthMiddleware(authCli)).
			With(httputil.RequireRole(pb.AuthRole_ADMIN)).
			Post("/setrole", authV1.SetRole)
